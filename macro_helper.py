...
parser.add_argument('--type', type=str, choices=['word_macro_caesar', 'word_macro_workflow_compiler', 'word_macro_msbuild','xlm4_macro_runner'], default="word_macro_workflow_compiler")
